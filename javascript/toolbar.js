	...
	var e = '<div class="toolbar clearfix">'+
                '<div class="products">'+
                    '<a class="active-theme">'+
                        '<span class="theme-title">Bond</span>'+
                    '</a>'+
                    '<ul class="dropdown">'+
                ...
                '<div class="buttons">'+
                    '<a href="" id="btn-purchase" class="btn green" target="_blank">Purchase</a>'+
                    '<a href="https://themeforest.net/item/bond-creative-agency-blogging-html-template/17590849?ref=themesflat" id="btn-close" class="btn black close">×</a>'+
                '</div>'+
            '</div>';
	$('body').append(e);
    toolBar();	
